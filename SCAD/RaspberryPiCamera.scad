...
module camera_screw(){
    translate([screw1_x,screw1_y,0]) cylinder(r=2/2, h=20, center=true);
		translate([screw2_x,screw2_y,0]) cylinder(r=2/2, h=20, center=true);
		translate([screw3_x,screw3_y,0]) cylinder(r=2/2, h=20, center=true);
		translate([screw4_x,screw4_y,0]) cylinder(r=2/2, h=20, center=true);
}
...
{
	translate([0,lens_housing_y-4-10/2+0.1,3/2+board_thickness/2]) cube([15,10,4], center=true);
}
